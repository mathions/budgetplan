...
export default function Beranda() {
  return (
    <>
      ...
      {/* <div className="">
        <div className="p-30">
          <div className="text-grey-900 text-6xl font-semibold text-center">Sistem informasi pengajuan <br/> anggaran belanja modal</div>
          <div>
            Budgetplan memfasilitasi proses pengajuan anggaran dari satuan kerja
            kepada biro umum
          </div>
        </div>
      </div> */}
        ...
        <div className="grid my-6 gap-4 max-w-[1000px]">
          ...
          <div className="rounded-xl border bg-card text-card-foreground p-10 flex flex-col-reverse md:flex-row ">
            <div className="md:basis-1/2 space-y-4">
              ...
              <p className="text-[18px] text-foreground/60 font-normal">
                Buat usulan kebutuhan belanja modal dengan mengunggah dokumen
                brafaks dan mengisi rencana anggaran biaya (RAB). Biro Umum akan
                memproses pengajuan tersebut dan memberikan penyesuaian RAB.
              </p>
              <Button asChild>
          ...
          <div className="rounded-xl border bg-card text-card-foreground p-10 flex flex-col md:flex-row ">
            ...
            <div className="md:basis-1/2 space-y-4">
              ...
              <p className="text-[18px] text-foreground/60 font-normal">
                Anggaran Biaya Tambahan (ABT) adalah alokasi tambahan anggaran
                pada tahun berjalan yang bersifat mendesak. Satuan kerja dapat
                membuat pengajuan ABT dengan mengisi perihal dan mengunggah
                dokumen brafaks untuk kemudian diproses oleh Biro Umum.
              </p>
              <Button asChild>
