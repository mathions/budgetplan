  ...
  return (
    <>
      ...
      <div className="grid my-6 gap-4 max-w-[1000px]">
        <div className="h-60 rounded-xl bg-card  p-6 grid content-center flex-row justify-center">
          <div className="flex justify-center">
        ...
        <div className="rounded-xl border bg-card text-card-foreground shadow p-10 flex flex-col-reverse md:flex-row ">
          <div className="md:basis-1/2 space-y-4">
            ...
            <p className="text-[18px] text-foreground/60 font-normal">
              Buat usulan yang berisi brafaks dan rencana anggaran biaya (RAB). 
              Tunggu proses verifikasi dari biro umum.
              Apabila usulan diterima, satuan kerja
              akan menerima RAB yang disesuaikan berdasarkan 
          ...
          <div className="md:basis-1/2 flex justify-center mb-4 md:mb-0">
            <Image src="/image/1.png" alt="belanja-modal" width={400} height={300}/>
          </div>
        </div>
        <div className="rounded-xl border bg-card text-card-foreground shadow p-10 flex flex-col md:flex-row ">
          ...
          <div className="md:basis-1/2 space-y-4">
            ...
            <p className="text-[18px] text-foreground/60 font-normal">
              ...
              pengajuan ABT dengan mengirimkan perihal dan 
              brafaks untuk kemudian diproses oleh Biro Umum.
            </p>
            <Button asChild>
