...
export default function Header () {
  ...
  return (
    <header className="sticky top-0 z-40 w-full flex justify-start md:justify-center border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
